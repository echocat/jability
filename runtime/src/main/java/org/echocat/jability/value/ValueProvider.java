...
public interface ValueProvider<V extends Value<?>> extends Iterable<V> {
     ...
     */
    @Nullable
    public <V> Value<V> provideBy(@Nonnull Class<V> valueType, @Nonnull String id) throws IllegalArgumentException;
